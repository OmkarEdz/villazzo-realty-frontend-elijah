...
const PropertyThree = ({
  ...
  return (
        ...
        {isMounted && (
          ...
          <div className="pro_det_img_wrap">
            <Slider {...settingsFor} className="slider-for" asNavFor={nav2} ref={slider => setNav1(slider)}>
              {propertythree.attributes.PropertyImgs.map((element, index, array) => (
              <div key={index} className="slide-img">
                  <Image
                    ...
                    alt="Villazzo"
                  />
                  <p className="for_sell_wrap">{propertythree.attributes.PropertyImgDetails.PropertyStatus}</p>
              </div>
              ))}
            </Slider>
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertythree.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertythree.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertythree.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertythree.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertythree.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertythree.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertythree.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertythree.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertythree.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertythree.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertythree.attributes.PropertyImgDetails.MemberPhone)}`}>{propertythree.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertythree.attributes.PropertyImgDetails.MemberEmail)}`}>{propertythree.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertythree.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  const [
	...
	fetchAPI("/propertythree", { populate: "*" }),
  ...
  return {
    props: {
      ...
      propertythree: propertythreeRes.data,
