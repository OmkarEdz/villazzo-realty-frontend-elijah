				...
				<div className="meet-wrap">
					<div className="meet-left">
						<p className="meet-left-img">
							<Image
								loader={myLoader}
								src={`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${christianjagodzinski.attributes.memberImageURL}`}
								className="header_image"
								layout="fill"
								alt="Villazzo"
							/> 
						</p>
						<h3 className="meet-left-name">{christianjagodzinski.attributes.memberName}</h3>
						<p className="broker">{christianjagodzinski.attributes.memberType}</p>
						<a className="number" href={`tel:${encodeURIComponent(christianjagodzinski.attributes.contactNo)}`}>{christianjagodzinski.attributes.contactNo}</a>
						<a className="email" href={`mailto:${encodeURIComponent(christianjagodzinski.attributes.memberEmail)}`}>{christianjagodzinski.attributes.memberEmail}</a>
					</div>
					<div className="meet-right">
						<p>{christianjagodzinski.attributes.Content}</p>
					</div>
				</div>
				<div className="properties">
					<h1 className="team-heading">FEATURED PROPERTIES</h1>
					<div className="property-wrap">
						{mainPropertyList.map((element, i) => (
						<div key={i} className="property-box">
