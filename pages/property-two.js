...
const PropertyTwo = ({
  ...
  return (
        ...
        {isMounted && (
          ...
          <div className="pro_det_img_wrap">
            <Slider {...settingsFor} className="slider-for" asNavFor={nav2} ref={slider => setNav1(slider)}>
              {propertytwo.attributes.PropertyImgs.map((element, index, array) => (
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertytwo.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertytwo.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertytwo.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertytwo.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertytwo.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertytwo.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertytwo.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertytwo.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertytwo.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertytwo.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertytwo.attributes.PropertyImgDetails.MemberPhone)}`}>{propertytwo.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertytwo.attributes.PropertyImgDetails.MemberEmail)}`}>{propertytwo.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertytwo.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      propertytwo: propertytwoRes.data,
