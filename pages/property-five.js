...
const TopDeals = ({
  ...
  return (
            ...
            <Slider {...settingsFor} className="slider-for" ref={sliderForRef}>
              ...
              <div key={index} className="slide-img">
                  <Image
                    ...
                    alt="Villazzo"
                  />
                  <p className="for_sell_wrap">{propertyfive.attributes.PropertyImgDetails.PropertyStatus}</p>
              </div>
              ))}
            </Slider>
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertyfive.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertyfive.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertyfive.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertyfive.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertyfive.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertyfive.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertyfive.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertyfive.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertyfive.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertyfive.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertyfive.attributes.PropertyImgDetails.MemberPhone)}`}>{propertyfive.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertyfive.attributes.PropertyImgDetails.MemberEmail)}`}>{propertyfive.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertyfive.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  const [
	...
	fetchAPI("/propertyfive", { populate: "*" }),
  ...
  return {
    props: {
      ...
      propertyfive: propertyfiveRes.data,
