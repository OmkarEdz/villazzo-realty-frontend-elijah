...
const PropertyFour = ({
  ...
  return (
            ...
            <Slider {...settingsFor} className="slider-for" asNavFor={nav2} ref={slider => setNav1(slider)}>
              ...
              <div key={index} className="slide-img">
                  <Image
                    ...
                    alt="Villazzo"
                  />
                  <p className="for_sell_wrap">{propertyfour.attributes.PropertyImgDetails.PropertyStatus}</p>
              </div>
              ))}
            </Slider>
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertyfour.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertyfour.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertyfour.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertyfour.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertyfour.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertyfour.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertyfour.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertyfour.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertyfour.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertyfour.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertyfour.attributes.PropertyImgDetails.MemberPhone)}`}>{propertyfour.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertyfour.attributes.PropertyImgDetails.MemberEmail)}`}>{propertyfour.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertyfour.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  const [
	...
	fetchAPI("/propertyfour", { populate: "*" }),
  ...
  return {
    props: {
      ...
      propertyfour: propertyfourRes.data,
