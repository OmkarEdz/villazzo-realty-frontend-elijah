...
const SoldBy = ({
  ...
  navigation,
	...
	// let newDevPropList = soldbypage.attributes.Proprties
  ...
  if (moreBtn.current) {
    ...
    if (soldbypage.attributes.soldProperties.length > 4) {
      ...
      <div className="bg-img bg-white new_dev_pg_wrap">
		...
		<div className="container">
			<div className="buttons-wrap video-wrapper team-wrapper dev-wrapper">
				<h1 className="sold-heading sold-new-heading">Sold By 
          <span>
            <Image
              loader={myLoader}
              ...
              alt="Villazzo"
            />
            {/* <img src="https://www.villazzorealty.com/_next/static/media/villazzo-symbol.91f471d2.png" alt="Image" /> */}
          </span>
        </h1>
            ...
            <div className="pro-text" dangerouslySetInnerHTML={{ __html: element.subheading }}></div>
                ...
                <div className="video-btn contact-btn sold-btn" ref={moreBtn}>
