...
const PropertyOne = ({
  ...
  return (
            ...
            <Slider {...settingsFor} className="slider-for" asNavFor={nav2} ref={slider => setNav1(slider)}>
              ...
              <div key={index} className="slide-img">
                  <Image
                    ...
                    alt="Villazzo"
                  />
                  <p className="for_sell_wrap">{propertyone.attributes.PropertyImgDetails.PropertyStatus}</p>
              </div>
              ))}
            </Slider>
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertyone.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertyone.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertyone.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertyone.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertyone.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertyone.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertyone.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertyone.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertyone.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertyone.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertyone.attributes.PropertyImgDetails.MemberPhone)}`}>{propertyone.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertyone.attributes.PropertyImgDetails.MemberEmail)}`}>{propertyone.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertyone.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      propertyone: propertyoneRes.data,
