...
const TopDeals = ({
  ...
  return (
        ...
        {isMounted && (
          ...
          <div className="pro_det_img_wrap">
            <Slider {...settingsFor} className="slider-for" ref={sliderForRef}>
              {propertynine.attributes.PropertyImgs.map((element, index, array) => (
              <div key={index} className="slide-img">
                  <Image
                    ...
                    alt="Villazzo"
                  />
                  <p className="for_sell_wrap">{propertynine.attributes.PropertyImgDetails.PropertyStatus}</p>
              </div>
              ))}
            </Slider>
            <Slider {...settingsNav} className="slider-nav" ref={sliderNavRef}>
              {propertynine.attributes.PropertyImg.map((element, index, array) => (
                <div key={index} className="slide-img">
                    <Image
                      loader={myLoader}
                      // src={process.env.NEXT_PUBLIC_STRAPI_API_URL}
          ...
          <div className="pro_det_cont_wrap">
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                ...
                <p className="pro_det_value">{propertynine.attributes.PropertyImgDetails.PropertyLoc}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bedrooms</p>
                <p className="pro_det_value">{propertynine.attributes.PropertyImgDetails.Bedrooms}</p>
              </div>
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Bathrooms</p>
                <p className="pro_det_value">{propertynine.attributes.PropertyImgDetails.Bathrooms}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Price</p>
                <p className="pro_det_value">{propertynine.attributes.PropertyImgDetails.Price}</p>
              </div>
            </div>
            <div className="pro_det_row_wrap">
              <div className="pro_det_row_item">
                <p className="pro_det_lbl">Description</p>
                <p className="pro_det_value">{propertynine.attributes.PropertyImgDetails.Description}</p>
              </div>
            </div>
            <div className="meet-left main-team">
                <p className="meet-left-img">
                  <a href={propertynine.attributes.PropertyImgDetails.MemberLink}>
                    <Image
                      loader={myLoader}
                      src= {`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${propertynine.attributes.PropertyImgDetails.MemberImgUrl}`}
                ...
                <h3 className="meet-left-name">
                  <a href={propertynine.attributes.PropertyImgDetails.MemberLink} className="meet-left-name-link">{propertynine.attributes.PropertyImgDetails.MemberName}</a>
                </h3>
                <p className="broker">{propertynine.attributes.PropertyImgDetails.MemberDes}</p>
                <a className="number" href={`tel:${encodeURIComponent(propertynine.attributes.PropertyImgDetails.MemberPhone)}`}>{propertynine.attributes.PropertyImgDetails.MemberPhone}</a>
                <a className="email" href={`mailto:${encodeURIComponent(propertynine.attributes.PropertyImgDetails.MemberEmail)}`}>{propertynine.attributes.PropertyImgDetails.MemberEmail}</a>
            </div>
    ...
    <div className="map_wrap">
      <div dangerouslySetInnerHTML={{ __html: propertynine.attributes.MapIframe }} />
    </div>
      </div>
...
export async function getStaticProps() {
  ...
  const [
	...
	fetchAPI("/propertynine", { populate: "*" }),
  ...
  return {
    props: {
      ...
      propertynine: propertynineRes.data,
