...
//           <PropertyCard />
//           <div className="buttons-wrap video-wrapper team-wrapper inside-wrap detail-pg-wrap">
//             <button type="button" onClick={() => history.go(-1)} className="backBtn"><i className="fa fa-long-arrow-left" aria-hidden="true"></i> Back</button>
//             <div className="meet-wrap property-flex-wrap">
...
//                 <h3 className="property-name">THE WALDORF ASTORIA</h3>
...
//                 <div className="property-desc">
//                   <h4>Location:</h4>
//                   <p>440 NE 5th St. Miami, FL 33132</p>
//                 </div>
//               </div>
//             </div>
//           </div>
